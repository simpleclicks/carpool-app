            ...
            function ($scope, $attrs, $ionicSideMenuDelegate, $ionicPlatform) {
                ...
                this.isDraggableTarget = function (e) {
                    ...
                    return ($scope.dragContent || self.isOpen()) &&
                        dragIsWithinBounds && !e.gesture.srcEvent.defaultPrevented && !e.target.tagName.match(/input|textarea|select|object|embed/i) && !e.target.isContentEditable && !(e.target.dataset ? e.target.dataset.preventScroll : e.target.getAttribute('data-prevent-default') == 'true');
                };
    ...
    IonicModule
        .directive('ionInfiniteScroll', ['$timeout', function ($timeout) {
            ...
            return {
                ...
                template: '<div class="scroll-infinite">' +
    ...
    IonicModule
        .directive('ionRefresher', ['$ionicBind', function ($ionicBind) {
            return {
                ...
                replace: true,
                require: '^$ionicScroll',
                template: '<div class="scroll-refresher">' +
